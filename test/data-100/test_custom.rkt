...
(define q1s (SELECT (VALS "NYC_JOIN_SF.CMTE_ID" "NYC_JOIN_SF.TRANSACTION_AMT" "NYC_JOIN_SF.NAME" "NYC_JOIN_SF.CMTE_ID0" "NYC_JOIN_SF.TX_AMT" "NYC_JOIN_SF.DESCRIPTION") FROM (AS (JOIN (NAMED NYC) (NAMED SF)) [ "NYC_JOIN_SF" (list "CMTE_ID" "TRANSACTION_AMT" "NAME" "CMTE_ID0" "TX_AMT" "DESCRIPTION") ]) WHERE (AND (BINOP "NYC_JOIN_SF.CMTE_ID" = "NYC_JOIN_SF.CMTE_ID0") (BINOP "NYC_JOIN_SF.CMTE_ID" = 1)) ))
