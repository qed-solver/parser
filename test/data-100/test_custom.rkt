...
(define q1s (SELECT (VALS "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.CMTE_ID" "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.TRANSACTION_AMT" "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.NAME" "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.ID" "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.TX_AMT" "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.DESCRIPTION") FROM (AS (JOIN (NAMED INDIV_SAMPLE_NYC) (NAMED INDIV_SAMPLE_SF)) [ "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF" (list "CMTE_ID" "TRANSACTION_AMT" "NAME" "ID" "TX_AMT" "DESCRIPTION") ]) WHERE (AND (BINOP "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.CMTE_ID" = "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.ID") (BINOP "INDIV_SAMPLE_NYC_JOIN_INDIV_SAMPLE_SF.CMTE_ID" = 1)) ))
